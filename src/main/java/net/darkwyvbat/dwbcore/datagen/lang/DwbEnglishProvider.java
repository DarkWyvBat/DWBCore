...
public class DwbEnglishProvider extends FabricLanguageProvider {
    ...
    public DwbEnglishProvider(FabricPackOutput fabricDataOutput, CompletableFuture<HolderLookup.Provider> completableFuture) {
    ...
    public void generateTranslations(HolderLookup.Provider provider, TranslationBuilder builder) {
        ...
        builder.add(DwbDebugContent.HUMANOID_TESTER, "Humanoid Tester");
    }
}